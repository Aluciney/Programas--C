/*
Função : Um determinado material radioativo perde metade de sua massa a cada 50 segundos. Dada a massa
inicial, em gramas, determina o tempo necessário para que essa massa se torne menor que 0,05 gramas.
